...
const IconThermometerFilled: React.ComponentType<IconProps> = (props) =>{
    return (
...
<Path fill={props.color} d="M12.726 17.925c0 .408-.325.74-.726.74a.733.733 0 0 1-.726-.74c0-.409.325-.74.726-.74.401 0 .726.331.726.74Z"/>
</Svg>
    )
}
