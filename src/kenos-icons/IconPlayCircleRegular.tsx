...
const IconPlayCircleRegular: React.ComponentType<IconProps> = (props) =>{
    return (
        <Svg  width={props.size} height={props.size}>
<Path fill={props.color} d="M9.198 16.31a.484.484 0 0 1-.487-.485V8.143a.484.484 0 0 1 .728-.42l6.652 3.84a.484.484 0 0 1 0 .84L9.44 16.247a.501.501 0 0 1-.241.064Zm.485-1.328 5.196-3-5.196-3v6Z"/>
