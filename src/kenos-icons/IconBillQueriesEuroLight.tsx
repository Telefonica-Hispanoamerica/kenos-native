...
const IconBillQueriesEuroLight: React.ComponentType<IconProps> = (props) =>{
    return (
        <Svg  width={props.size} height={props.size}>
<Path fill={props.color} d="M19.435 19.407a.74.74 0 1 1-1.478 0 .74.74 0 0 1 1.478 0ZM19.066 17.189v-4.447a.37.37 0 0 0-.74 0v4.447a.37.37 0 0 0 .74 0Z"/>
