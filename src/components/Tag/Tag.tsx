...
const Tag: React.FC<TagProps> = ({
  ...
  const [textColor, inverseTextColor, backgroundColor, inverseBackGroundColor] =
      ...
      style={
        withBackground
          ? [
              styles.tag,
              {
                paddingLeft: Icon ? 6 : 10,
                backgroundColor: isInverseTag
                  ? inverseBackGroundColor
                  : backgroundColor,
              },
            ]
          : [styles.tag, {paddingLeft: Icon ? 8 : 12}]
      }>
      {Icon && (
        <Box paddingRight={4}>
